This repository is a naive implementation of the *ACM International Collegiate World Finals Programming Contest 2011, Problem F*, in various language, mostly for fun.
